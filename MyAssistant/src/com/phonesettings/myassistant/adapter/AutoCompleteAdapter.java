...
public class AutoCompleteAdapter extends ArrayAdapter<Address> implements Filterable {
    ...
    public AutoCompleteAdapter(final Context context, Geocoder geoCoder) {
        super(context, -1);
    ...
    public Filter getFilter() {
        Filter myFilter = new Filter() {
            ...
            protected void publishResults(final CharSequence contraint, final FilterResults results) {
                ...
                if(results.count < 2){
                    // if we just have tapped we don't need to show the address
                    return;
                }
...
// Source: http://android.foxykeep.com/dev/how-to-add-autocompletion-to-an-edittext